...
import com.jharbes.vendasapp.dtos.AtualizacaoStatusPedidoDTO;
...
public class PedidoController {
	...
	// utilizamos aqui o PatchMapping para que seja atualizado apenas o status, se
	// formos utilizar o Put teremos que sobrescrever novamente todos os atributos
	// do pedido, com o patch isso é desnecessario
	@PatchMapping("/{id}")
	...
	private InformacoesPedidoDTO converter(Pedido pedido) {
		return InformacoesPedidoDTO.builder().codigo(pedido.getId())
				...
				.totalPedido(pedido.getTotalPedido()).status(pedido.getStatus().name())
